## codebook.md
The variables for this data set are listed in the "features.txt" file.
In addition there are subject, activity, and an observation variables. The
observation variable specifies in the merged data whether an obeservation 
came from the "test" or "training" data set.

### Feature explanation included with data set
Feature Selection 
